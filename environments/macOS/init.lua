-- === ostt Hammerspoon Configuration ===
--
-- Advanced alternative to the Shortcuts.app setup.
-- See README.md for the simpler recommended approach using `ostt launch`.
--
...
local HOTKEYS = {
	...
	-- Cmd+Shift+R: Record and copy (alternative)
	{
		mods = { "cmd", "shift" },
		key = "R",
		ostt_args = "-c",
